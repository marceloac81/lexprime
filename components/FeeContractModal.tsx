...
import { X, FileText, Copy, DollarSign, ChevronDown } from './Icons';
                ...
                <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
                                    ...
                                    >
                                        <span className="truncate pr-2 text-slate-700 dark:text-slate-200">
                                            {selectedCaseId 
                                                ? (() => {
                                                    const c = cases.find(x => x.id === selectedCaseId);
                                                    return c ? `${c.number} - ${c.title}` : 'Nenhum';
                                                  })()
                                                : 'Nenhum'}
                                        </span>
                    ...
                    <div className="flex-1 p-6 flex flex-col bg-slate-200 dark:bg-black/20 overflow-hidden">
                        <div className="flex justify-between items-center mb-3">
                            <label className="block text-xs font-bold text-slate-500 uppercase">Contrato Gerado</label>
                            <button
